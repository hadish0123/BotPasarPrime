...
def upgrade() -> None:
    ...
    # Older revisions used either a global unique(name) or tenant_id+name.
    # Replace either form with PostgreSQL partial unique indexes so global
    # system roles remain unique while each tenant may define the same name.
